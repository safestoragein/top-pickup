        // Bangalore pickup data with comprehensive apartment listings (2+ bookings)
        const pickupData = [
            {
                rank: 1,
                area: "Unknown",
                ...
                apartments: [
                    ...
                    {name: "MJ Lifestyle Amadeus", count: 2},
                    {name: "PURVA SEASONS", count: 2},
                    {name: "Somasundarapalya", count: 3},
                    {name: "Lakshmi Nilaya", count: 2},
                    ...
                    {name: "Indian Institute Of Management–Bangalore (IIM–Bangalore)", count: 5},
                    {name: "Bangalore", count: 7},
                    {name: "Sobha Dream Acres", count: 5},
                    {name: "Arekere", count: 2},
                    {name: "Domlur", count: 3},
                    {name: "J. P. Nagar", count: 5},
                    {name: "Prabhavathi Elegant", count: 2},
                    {name: "Telecom Layout", count: 3},
                    {name: "Airavatam Apartments", count: 2},
                    {name: "Bengaluru", count: 9},
                    {name: "5th Phase", count: 5},
                    {name: "Srinidhi Residency", count: 2},
                    {name: "GM Palya", count: 2},
                    {name: "Bren EdgeWaters", count: 2},
                    ...
                    {name: "Choodasandra", count: 3},
                    {name: "Sandeep Vihar", count: 2},
                    ...
                    {name: "New Thippasandra", count: 2},
                    {name: "Panduranga Nagar", count: 2},
                    {name: "Arvind Oasis", count: 2},
                    {name: "Pradham Gardenia", count: 2},
                    ...
                    {name: "Yelahanka New Town", count: 2},
                    {name: "Kudlu Gate", count: 5},
                    {name: "Sai Sumukha Sameeksha", count: 3},
                    {name: "GM Infinite ECity Town Phase 2", count: 2},
                    {name: "Sahakar Nagar", count: 2},
                    {name: "Ozone Urbana", count: 3},
                    {name: "BTM 1st Stage", count: 4},
                    {name: "Kothanur", count: 4},
                    {name: "WeWork", count: 10},
                    ...
                    {name: "Bren Avalon", count: 2},
                    {name: "ICONEST3", count: 2},
                    ...
                    {name: "Building No./Flat No.: A-71 Name Of Premises/Building: A-71 Road/Street: SECTOR 4 City/Town/Village: Noida District: Gautambuddha Nagar State: Uttar Pradesh PIN Code: 201301", count: 2},
                    {name: "Kattigenahalli", count: 2},
                    {name: "Bhadrappa Layout", count: 2},
                    {name: "JC Industrial Estate", count: 2},
                    {name: "Intermodal Castle", count: 2}
                ]
            },
            {
                rank: 2,
                ...
                apartments: [
                    ...
                    {name: "Spectra Raaya", count: 2},
                    {name: "16058", count: 2},
                    {name: "Prestige Lakeside Habitat", count: 4},
                    {name: "Outer Circle", count: 2},
                    {name: "Prestige Park View", count: 2},
                    {name: "Nallurhalli", count: 5},
                    {name: "Meenakshi Layout Road", count: 2},
                    {name: "Prestige Shantiniketan Apartment Complex", count: 4},
                    {name: "Mahaveer Tranquil", count: 2},
                    {name: "Immadihalli", count: 5},
                    {name: "Windmills", count: 2},
                    {name: "Siddapura", count: 2},
                    {name: "Pattandur Agrahara", count: 2},
                    {name: "Vaswani Brentwood", count: 2},
                    {name: "Thubarahalli", count: 2},
                    {name: "Casa Gopalan", count: 2},
                    {name: "DivyaSree Republic of Whitefield", count: 2},
            ...
            },
            {
                ...
                apartments: [
                    ...
                    {name: "Forest View Comforts", count: 2},
            ...
            },
            {
                ...
                apartments: [
                    ...
                    {name: "Colive 1155 Brighton", count: 2}
                ]
            },
            {
                rank: 8,
